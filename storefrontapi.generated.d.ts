...
export type GetStoreLockSettingsQueryVariables = StorefrontAPI.Exact<{
  metaobjectHandle: StorefrontAPI.MetaobjectHandleInput;
}>;

export type GetStoreLockSettingsQuery = {
...
export type AllProductsWithTagQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type AllProductsWithTagQuery = {
  products: {
    nodes: Array<
...
export type ProductDetailsWithFrameTagFragment = Pick<
  StorefrontAPI.Product,
  'id' | 'title' | 'handle' | 'tags'
> & {
  priceRange: {
...
export type FrameProductsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type FrameProductsQuery = {
  products: {
    nodes: Array<
      Pick<StorefrontAPI.Product, 'id' | 'title' | 'handle' | 'tags'> & {
        priceRange: {
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query getStoreLockSettings($metaobjectHandle: MetaobjectHandleInput!) {\n    metaobject(handle: $metaobjectHandle) {\n      handle\n      type\n      fields {\n        key\n        value\n      }\n    }\n  }\n': {
    return: GetStoreLockSettingsQuery;
    variables: GetStoreLockSettingsQueryVariables;
  };
  ...
  '#graphql\n  fragment ProductDetails on Product {\n    id\n    title\n    handle\n    tags\n    priceRange {\n      minVariantPrice {\n        amount\n        currencyCode\n      }\n    }\n    images(first: 1) {\n      nodes {\n        id\n        url\n        altText\n        width\n        height\n      }\n    }\n  }\n  query AllProductsWithTag($country: CountryCode, $language: LanguageCode) \n    @inContext(country: $country, language: $language) {\n    products(first: 250, query: "tag:homepage") {\n      nodes {\n        ...ProductDetails\n      }\n    }\n  }\n': {
    return: AllProductsWithTagQuery;
    variables: AllProductsWithTagQueryVariables;
  };
  '#graphql\n  fragment ProductDetailsWithFrameTag on Product {\n    id\n    title\n    handle\n    tags\n    priceRange {\n      minVariantPrice {\n        amount\n        currencyCode\n      }\n    }\n    images(first: 1) {\n      nodes {\n        id\n        url\n        altText\n        width\n        height\n      }\n    }\n  }\n  query FrameProducts($country: CountryCode, $language: LanguageCode) \n    @inContext(country: $country, language: $language) {\n    products(first: 250, query: "tag:frame") {\n      nodes {\n        ...ProductDetailsWithFrameTag\n      }\n    }\n  }\n': {
    return: FrameProductsQuery;
    variables: FrameProductsQueryVariables;
  };
